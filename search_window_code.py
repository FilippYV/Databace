...
class Ui_Search_window(object):
    def setupUi_search(self, Search_window):
        Search_window.setObjectName("Dell_window")
        Search_window.resize(716, 470)
        Search_window.setLayoutDirection(QtCore.Qt.RightToLeft)
        Search_window.setAutoFillBackground(True)
        Search_window.setDocumentMode(False)
        ...
        self.retranslateUi_add(Search_window)
