...
class Ui_Dell_window(object):
    def setupUi_dell(self, Dell_window):
        Dell_window.setObjectName("Dell_window")
        Dell_window.resize(716, 470)
        Dell_window.setLayoutDirection(QtCore.Qt.RightToLeft)
        Dell_window.setAutoFillBackground(True)
        Dell_window.setDocumentMode(False)
        ...
        self.retranslateUi_add(Dell_window)
    ...
    def retranslateUi_add(self, Dell_window):
        _translate = QtCore.QCoreApplication.translate
        Dell_window.setWindowTitle(_translate("Dell_window", "Добавить данные"))
        self.label_add.setText(_translate("Dell_window", "Что удалить?"))
        # self.comboBox_add.setItemText(0, _translate("Dell_window", "Пользователя"))
        # self.comboBox_add.setItemText(1, _translate("Dell_window", "Рейс"))
        # self.comboBox_add.setItemText(2, _translate("Dell_window", "Маршрут"))
        # self.comboBox_add.setItemText(3, _translate("Dell_window", "Аэропорт вылета"))
        # self.comboBox_add.setItemText(4, _translate("Dell_window", "Аэропорт назначения"))
        # self.comboBox_add.setItemText(5, _translate("Dell_window", "Билет"))
        # self.comboBox_add.setItemText(6, _translate("Dell_window", "Авиакомпанию"))
        # self.comboBox_add.setItemText(7, _translate("Dell_window", "Самолёт"))
        # self.comboBox_add.setEnabled(True)
        # self.lineEdit_add.setPlaceholderText(_translate("Dell_window", "Фамилия"))
        # self.lineEdit_add_2.setPlaceholderText(_translate("Dell_window", "Имя"))
        # self.lineEdit_add_3.setPlaceholderText(_translate("Dell_window", "Отчество"))
        # self.lineEdit_add_4.setPlaceholderText(_translate("Dell_window", "Серия"))
        # self.lineEdit_add_5.setPlaceholderText(_translate("Dell_window", "Номер"))
        # self.lineEdit_add_6.setPlaceholderText(_translate("Dell_window", "Регистрация"))
        # self.lineEdit_add_7.setPlaceholderText(_translate("Dell_window", "Почта"))
        # self.lineEdit_add_8.setPlaceholderText(_translate("Dell_window", "Телефон"))
        # self.lineEdit_add_9.setPlaceholderText(_translate("Dell_window", ""))
