...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_change.setText(_translate("MainWindow", "Изменить данные"))
        ...
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.passport_users_tab), _translate("MainWindow", "Паспорта"))
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.users_tab), _translate("MainWindow", "Пользователи"))
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.airport_out_tab), _translate("MainWindow", "Аэропрот вылета"))
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.airport_in_tab), _translate("MainWindow", "Аэропорт назначения"))
        ...
        self.pushButton_coman_line.setText(_translate("MainWindow", "Строка"))
